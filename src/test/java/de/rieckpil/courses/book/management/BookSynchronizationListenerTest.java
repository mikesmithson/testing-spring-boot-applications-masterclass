...
class BookSynchronizationListenerTest {
  ...
  private static final String NON_EXISTENT_VALID_ISBN =
      new StringBuilder("1234567891234").reverse().toString();
  private static final BookSynchronization VALID_BOOK_ISBN = new BookSynchronization(VALID_ISBN);
  private static final BookSynchronization INVALID_BOOK_ISBN =
      new BookSynchronization(INVALID_ISBN);
  private static final BookSynchronization NON_EXISTENT_VALID_BOOK_ISBN =
      new BookSynchronization(NON_EXISTENT_VALID_ISBN);
